...
const ASeriesOfHoodiesTShirtsAndToteBags = (props) => {
  return (
    <div className="a-series-of-hoodies-t-shirts-and-tote-bags-container">
      <Helmet>
        <title>
          a-series-of-hoodies-t-shirts-and-tote-bags - Ana Portofolio
        </title>
        <meta
          property="og:title"
...
export default ASeriesOfHoodiesTShirtsAndToteBags
