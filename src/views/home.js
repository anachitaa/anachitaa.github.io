  ...
  return (
    <div className="home-container">
      ...
      <div className="home-frame47">
        ...
        >
          <div className="home-image8">
            ...
            <span className="home-text04">
              <span>and tote bags</span>
            </span>
          </div>
        </Link>
        <Link id="o1" to="/roots" className={`home-navlink ${!isActive('others') ? "hidden" : ""}`}>
          <div className="home-image5">
            ...
            <span className="home-text06">a series of photos - Roots</span>
          </div>
        </Link>
        <Link id="t1" to="/a-font-meant-for-display" className={`home-navlink ${!isActive('type')? "hidden" : ""}`}>
        ...
        <Link id="p1" to="/a-publication" className={`home-navlink ${!isActive('publication') ? "hidden" : ""}`}>
        ...
        <Link className={`home-navlink ${!isActive("branding") ? "hidden" : ""}`}>
        <div id="b1" className="home-iamge1">
        ...
        <Link to="/d" id="3d1" className={`home-navlink ${!isActive('3d') ? "hidden" : ""}`}>
        ...
        <Link to="/d" id="3d2" className={`home-navlink ${!isActive("3d") ? "hidden" : ""}`}>
        ...
        <Link className={`home-navlink ${!isActive("publication") ? "hidden" : ""}`}>
        <div id="p2" className="home-image21">
          <div className="home-group451">
            ...
            <img
              alt="Rectangle275392"
              src="/external/rectangle275392-bqa66-300h.png"
      ...
      <Link to="/cafe" className={`home-navlink ${!isActive("branding") ? "hidden" : ""}`}>
        <div id="b2" className="home-iamge12">
          ...
          <span className="home-text19">
            <span>a logo for a coffee place</span>
          </span>
      </div>
      </Link>
      <Link className={`home-navlink ${!isActive("others") ? "hidden" : ""}`}>
        <div id="o2" className="home-image22">
        ...
        <Link to="/unity" id="03" className={`home-navlink ${!isActive("others") ? "hidden" : ""}`}>
          <div className="home-iamge13">
            ...
            <span className="home-text23">a unity game</span>
          </div>
        </Link>
        <Link to="/animations" id="a1" className={`home-navlink ${!isActive("animations") ? "hidden" : ""}`}>
        ...
        <Link to="/animations" id="a2" className={`home-navlink ${!isActive("animations") ? "hidden" : ""}`}>
          <div className="home-iamge14">
            <div className="home-group444">
              ...
              <img
                alt="Rectangle265392"
                src="/external/rectangle265392-fkno-300w.png"
        ...
        <Link to="/it-company" className={`home-navlink ${!isActive("branding") ? "hidden" : ""}`}>
         <div id="b3" className="home-iamge15">
            ...
            <span className="home-text28">a logo for an IT company</span>
          </div>
        </Link>
        <Link to="/animations" id="a3" className={`home-navlink ${!isActive("animations") ? "hidden" : ""}`}>
          <div className="home-image52">
            ...
            <span className="home-text29">and another animation</span>
          </div>
        </Link>
        <Link to="/animations" id="a4" className={`home-navlink ${!isActive("animations") ? "hidden" : ""}`}>
          <div className="home-iamge16">
            ...
            <span className="home-text30">and another animation</span>
          </div>
        </Link>
      </div>
    </div>
